...
#teoria
Cada decisión tiene un antecedente corporal. Antes de que la mente consciente evalúe opciones, el cuerpo ya ha emitido su veredicto.
...
**Afecto de base: el clima emocional de fondo**

El cerebro no interpreta la información interoceptiva de forma aislada. La combina con datos del entorno y de la memoria para generar una sensación general: el afecto de base. Este determina si, en un momento dado, la experiencia se tiñe de bienestar, malestar o neutralidad.

El mismo síntoma físico adquiere significados distintos según el contexto. Un ritmo cardíaco acelerado en casa, tras hacer ejercicio, se interpreta como energía positiva. El mismo ritmo acelerado antes de una presentación se interpreta como ansiedad. El afecto de base opera como un filtro perceptivo: no solo influye en cómo se interpreta la información, sino en qué información llega siquiera a ser relevante.

**Valencia: la evaluación automática**

La valencia determina si el afecto de base es positivo (placer) o negativo (displacer). Es una respuesta automática que orienta hacia lo que beneficia y aleja de lo que amenaza. Este proceso de placer/displacer genera emociones que impulsan a actuar: acercarse a lo que nutre, alejarse de lo que daña.

Cuando la valencia es negativa, la motivación para reducir el malestar se activa. Puedes decidir evitar el evento social para escapar de la incomodidad, o bien prepararte emocionalmente buscando recursos que reduzcan la tensión.

**Activación: la intensidad de la respuesta**
...
Valencia y activación combinadas guían la decisión final. La valencia indica qué buscar o evitar; la activación determina con qué urgencia. Alta activación y valencia negativa pueden llevar a evitar la situación. Baja activación y valencia negativa pueden permitir asistir al evento, pero con estrategias de manejo preparadas.
...
#explicacion
La implicación práctica de esta cadena: el estado corporal no es ruido de fondo, es información. La interocepción actúa como sistema de monitoreo constante que alimenta el afecto de base, que a su vez tiñe la percepción y orienta las decisiones.
...
#teoria
Este mecanismo de la cadena emocional tiene consecuencias directas en qué información llega a la consciencia.
...
La amígdala —estructura clave en la detección de estímulos emocionales— orienta la atención hacia estos estímulos antes de que haya plena consciencia de ellos. Un sonido repentino o una cara con expresión de miedo captan la atención automáticamente: la amígdala activa una respuesta rápida de alerta, redirigiendo los recursos atencionales hacia el posible peligro. Este proceso es esencial para la supervivencia y muestra cómo la atención está naturalmente predispuesta a reaccionar ante estímulos emocionales, especialmente aquellos que pueden implicar amenazas o recompensas. Damasio argumenta que esta interconexión entre sistemas emocionales y atencionales permite que el cerebro responda eficientemente a cambios en el entorno.

Las emociones determinan qué información se considera relevante en un momento dado. Si el estado es de aburrimiento, ansiedad o preocupación por algo ajeno al tema en cuestión, la mente divagará y no retendrá la información que se presenta. Un estudiante preocupado por un examen próximo tendrá dificultades para concentrarse en una lección sobre historia del arte.

Las emociones negativas pueden estrechar el foco de atención, dirigiéndolo hacia la fuente de la amenaza. Esta respuesta, útil en situaciones de peligro, puede ser contraproducente en otros contextos: impide percibir información importante y genera sesgo en la interpretación de la realidad. Por otro lado, las emociones positivas —alegría, curiosidad, entusiasmo— amplían el foco de atención, permitiendo explorar el entorno con mayor amplitud y receptividad.
...
#teoria
En la práctica, estos patrones automáticos se manifiestan en la toma de decisiones cotidiana.

Las emociones actúan como filtro a través del cual se percibe el mundo y se evalúan las opciones. La misma situación objetiva lleva a decisiones distintas según el estado emocional.

Cuando se experimentan **emociones positivas** —confianza, optimismo— la tendencia es hacia la impulsividad y la confianza en la intuición. Esta actitud puede ser beneficiosa en situaciones que requieren rapidez o apoyo emocional, pero puede llevar a errores en decisiones que requieren análisis cuidadoso.

Las **emociones negativas** —ansiedad, ira, tristeza— generan mayor cautela y tendencia a analizar en profundidad las posibles consecuencias. Si bien esto puede resultar útil en situaciones de riesgo, también puede llevar a pesimismo excesivo o a evitar decisiones importantes. En un estudio que simulaba el comercio de divisas, los participantes que experimentaban tristeza tomaron decisiones más precisas y realistas que aquellos que se sentían felices. La tristeza, al promover análisis más cuidadoso y evaluación más prudente de los riesgos, condujo a mejores resultados.

Las **emociones incidentales** —aquellas no relacionadas directamente con la decisión— pueden influir en el juicio sin que haya consciencia de ello. Una discusión con un compañero de trabajo por la mañana puede generar un estado de ánimo negativo que luego influya en cómo se evalúa una propuesta de un cliente, llevando a ser más críticos o a rechazarla sin evaluación objetiva.

Funcionarios de la libertad condicional y el cansancio: Las decisiones de los funcionarios de la junta de libertad condicional se ven influenciadas por su estado de fatiga, indicador de un afecto de base negativo. A medida que avanza la jornada, tienden a negar la libertad condicional con mayor frecuencia, a pesar de que los casos no difieren significativamente en cuanto a su mérito.
...
#explicacion
Esta influencia emocional en las decisiones a menudo ocurre de forma inconsciente. Las emociones incidentales pueden afectar el juicio sin que se note la conexión. Una discusión con los hijos puede generar frustración que luego influya en la forma de conducir al trabajo o de interactuar con compañeros, sin consciencia de ese vínculo.

**Ansiedad y toma de decisiones bajo presión:**

El caso del oficial Petrov: Durante la Guerra Fría, el oficial soviético Stanislav Petrov recibió una alerta de supuesto ataque nuclear estadounidense. Los sensores indicaban cinco misiles entrantes. El protocolo dictaba respuesta inmediata. A pesar de la presión extrema e incertidumbre, Petrov confió en su evaluación —algo no encajaba— y decidió no ordenar represalias, evitando potencialmente una catástrofe global.

El vuelo de prueba del Enterprise: Los pilotos, bajo intensa presión, decidieron aterrizar antes de lo previsto debido a preocupación por el combustible. Sin embargo, esta decisión resultó ser un error: el avión tenía suficiente combustible para completar el vuelo. La ansiedad sesgó su juicio.

**Afecto de base y decisiones cotidianas:**

Las abejas agitadas y la elección de alimentos: Un estudio demostró que las abejas agitadas tendían a rechazar una solución de sacarosa, interpretando un olor ambiguo como señal de peligro.
...
**Emociones específicas y toma de decisiones:**
...
**La influencia de la emoción en la intuición:**
...
**Reestructuración cognitiva: cambiar el impacto del pensamiento en la emoción**
...
**Reinterpretación de las emociones: cambiar el significado para modificar la respuesta**
...
**Etiquetado emocional en acción:**
...
**Sección 1 (Del cuerpo a la acción):** Eliminada gran parte del bloque #explicacion original que consistía en:
- Enumeración de los 5 componentes (Interocepción, Afecto de Base, Valencia, Activación, Impulso) que ya estaban explicados en detalle en #teoria
- Repetición de las mismas analogías ("radar interno", "clima emocional", "filtro de evaluación", "volumen de la experiencia", "sistema de navegación emocional") que ya aparecían en #teoria
- Reformulación de los mismos ejemplos sin añadir nueva información

Se preservó contenido de #explicacion que aportaba valor: la implicación práctica sobre afecto de base positivo/negativo y la frase de cierre sobre reconocer tensión e irritabilidad como datos.

### 2. Ausencias estructurales detectadas

- **Sección 2 (Emoción y atención):** No tiene bloque #explicacion en el original. El contenido #teoria es completo y autosuficiente.
- **Sección 3 (La mente automática):** No tiene bloque #explicacion en el original. El contenido #teoria es completo y autosuficiente.
