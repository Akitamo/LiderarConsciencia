...
Que filtros distorsionan mi percepcion del otro?

Este tema conecta los sesgos de M1 con las relaciones. Descubriras que los mismos mecanismos que distorsionan la percepcion de la realidad tambien distorsionan la percepcion de las personas.
...
- Si crees que Juan es incompetente, notaras sus errores e ignoraras sus aciertos
- Si crees que Maria es brillante, interpretaras sus errores como excepciones
...
- Misma formacion, mismos hobbies, mismo estilo
...
- Si el otro llega tarde: "Es irresponsable"
- Si yo llego tarde: "El trafico estaba terrible"
...
Reduces a la persona a una etiqueta y dejas de ver al individuo.

- "El conflictivo", "La lenta", "El quejica"
...
|----------------|-------------|
| Rapido | Juzgas en milisegundos |
| Automatico | Sin esfuerzo consciente |
| Invisible | No notas que estas sesgado |

Crees que "ves" a la persona. En realidad, ves tu construccion de la persona.
...
**En contratacion
- Favoreces candidatos similares a ti
- Filtras por afinidad, no por competencia

**En evaluacion
- El efecto halo distorsiona feedback
- La confirmacion mantiene percepciones incorrectas

**En desarrollo
- Inviertes mas en quienes "te gustan"
- Etiquetas limitan el potencial percibido

**En conflictos
- Error de atribucion intensifica el conflicto
- Etiquetas impiden ver la perspectiva del otro
...
El primer paso es notar que estas sesgado:
- "Estoy confirmando lo que ya creo?"
- "Que etiqueta estoy usando?"
- "Como me sentiria si fuera al reves?"

**Curiosidad

El segundo paso es abrir la percepcion:
- "Que no estoy viendo?"
- "Que me sorprenderia de esta persona?"
- "Que pasaria si mi primera impresion estuviera equivocada?"
...
En las relaciones, estos mismos sesgos operan:

| Sesgo general (M1) | Version interpersonal (M5) |
|--------------------|---------------------------|
| Confirmacion | Busco evidencia que confirme mi opinion del otro |
| Efecto halo | Una caracteristica positiva/negativa tine todo |
...
En las relaciones, ese espacio permite:
1. Notar la reaccion automatica ("Este tipo no me gusta")
2. Pausar antes de actuar desde ella
3. Considerar alternativas

Sin ese espacio, los sesgos actuan sin filtro.
...
- Que etiquetas usas para personas de tu equipo?
- Hay alguien a quien "no soportas"? Que sesgo podria estar operando?
- Cuando fue la ultima vez que cambiaste de opinion sobre alguien?

Los sesgos interpersonales tienen impacto sistemico:

- Equipos homogeneos (sesgo de afinidad)
- Promociones injustas (efecto halo)
- Conflictos cronicos (error de atribucion)
- Talento desperdiciado (etiquetado)

El lider consciente reconoce sus sesgos y los compensa deliberadamente.
