---
id: m06-03
titulo: "Transitar la decisión tomada — Estar con lo que ha pasado"
modulo: 6
orden: 03
fase: DESPUES
tags: [decision, revision, autocompasion, aprendizaje, proceso, cuidado]
...
#### Aprender de lo vivido sin destruirte en el proceso
...
## El DESPUÉS como continuación del proceso
...
## Autocompasión como base para aprender
...
La autocompasión no es lo contrario de la exigencia. Es lo que hace posible una exigencia sostenible.

Kristin Neff[^2] identificó tres componentes:

**Amabilidad hacia ti mismo.** Cuando te equivocas, tratarte con la misma consideración que tratarías a alguien que respetas y que ha cometido el mismo error. No porque "no importe", sino porque la crueldad no ayuda.

**Humanidad común.** Reconocer que equivocarse es parte de la experiencia compartida. No eres el único líder que se equivoca. Todos los que toman decisiones difíciles se equivocan. Esto no es excusa; es contexto.

**Mindfulness del dolor.** Reconocer que el error duele — hay decepción, vergüenza, frustración — sin sobre-identificarte con ese dolor. Sentirlo sin ser definido por él. "Esto duele" es diferente de "soy un desastre".
...
## Desde la revisión hacia la acción
...
## Práctica: Revisión contemplativa
