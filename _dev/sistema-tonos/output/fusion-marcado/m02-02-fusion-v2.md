...
2. **Walter Cannon**, profesor de Fisiología en Harvard, publicó en 1929 un artículo crucial que introdujo el concepto de homeostasis: la capacidad de los seres vivos para mantener equilibrio interno estable ante fluctuaciones externas[^1]. Cannon identificó mecanismos fisiológicos clave involucrados en la homeostasis, como la regulación de la temperatura corporal, la presión arterial, la glucemia y el pH sanguíneo.
...
#### Teoría del Marco Subjetivo Neuronal

4. **Teoría del Marco Subjetivo Neuronal** (Catherine Tallon-Baudry y Antonio Damasio):

#metafora
El cuerpo se convierte en el "lienzo" sobre el cual se "pinta" la experiencia subjetiva. El cerebro utiliza información del cuerpo para construir la experiencia subjetiva del mundo. La percepción no es solo un proceso cerebral, sino que está profundamente enraizada en el organismo y depende de la constante interacción entre cerebro y cuerpo.

#ejemplo
Una persona camina por un bosque y siente ligera incomodidad estomacal (señal interoceptiva). Simultáneamente percibe una sombra en el suelo y un sonido inusual (señales exteroceptivas). Según la Teoría del Marco Subjetivo Neuronal, el cerebro integra todas estas señales en una experiencia unificada: cuerpo y mente interpretan esta combinación como posible peligro, generando un estado de alerta. Este estado de alerta es una experiencia consciente que permite decidir el siguiente movimiento —salir del bosque o avanzar con cautela. Esta respuesta es posible porque el cerebro ha creado una "imagen subjetiva" del estado corporal y el entorno, interpretando las sensaciones en el marco de la experiencia actual.

#### El corazón como componente central
...
Como argumenta Damasio en "Sentir y saber": cualquier teoría que ignore el sistema nervioso al explicar mente y consciencia está destinada al fracaso, pero también lo está cualquier teoría que se base exclusivamente en él[^2].
...
#ejemplo
Investigadores alemanes estudiaron la influencia de la postura corporal en la memoria[^4]. Los participantes leían palabras con el ordenador a la altura de los ojos (postura erguida) o en el suelo (postura encorvada). Quienes encorvaban la espalda recordaron menos palabras en general y retuvieron en mayor proporción las de connotación negativa. La postura corporal sesga la codificación de información hacia lo negativo.
...
La respiración, especialmente la inspiración nasal, influye en la memoria. Actúa como un "marcapasos" para los ritmos neuronales del hipocampo —área cerebral crucial para la memoria—, mejorando la capacidad de codificar y recuperar información.

Ajustar la respiración en respuesta a un evento puede mejorar la memoria de ese evento. Un estudio del profesor Huijbers y su equipo demostró una relación significativa entre la respiración y la cantidad de elementos que es posible memorizar[^5].

#### Patrones respiratorios y emociones
...
[^1]: Walter Cannon (1929). Artículo sobre homeostasis, Harvard.
[^2]: Antonio Damasio. "Sentir y saber".
[^3]: Strack, Martin y Stepper (1988). Experimento del bolígrafo.
[^4]: Investigadores alemanes (2014). Estudio sobre postura corporal y memoria.
[^5]: Huijbers et al. (2014). Estudio sobre respiración y memoria.
[^6]: Universidad de Londres. Estudio sobre ciclo cardíaco y percepción.
[^7]: Universidad de Sussex. Estudio sobre ciclo cardíaco y percepción del dolor.
[^8]: Catherine Tallon-Baudry (2013). Estudio HER con EEG y ECG.
