...
Originalmente, esta respuesta estaba orientada a la supervivencia en situaciones extremas: enfrentar un depredador, escapar de un peligro inminente. El cuerpo se movilizaba, actuaba, y retornaba a la calma.

**El contexto ha cambiado; la maquinaria fisiológica, no.** Hoy, el trabajo, las relaciones, la presión social activan el mismo mecanismo diseñado para amenazas físicas reales. #metafora
...
Activa, motiva, energiza. Se asocia con retos percibidos como estimulantes: un proyecto desafiante, una competición deportiva, una presentación importante. #ejemplo El organismo se moviliza, pero la experiencia se vive como **oportunidad**, no como amenaza.

### Distrés: estrés negativo

Desgasta, agota, paraliza. Surge cuando las demandas se perciben como cargas que superan la capacidad de respuesta.

**No es la situación en sí lo que determina el tipo de estrés; es la interpretación de esa situación frente a los recursos disponibles.**

### El papel de la percepción

El estrés no es solo una respuesta a factores externos. Es una experiencia filtrada por la percepción:

- **Interpretación precede a sensación:** Si el cerebro evalúa amenaza, el cuerpo se prepara para luchar o huir, aunque la amenaza no sea física
- **Recursos como amortiguadores:** Habilidades, apoyo social, tiempo disponible, experiencia previa
- **Mismo estímulo, diferente respuesta:** La misma situación puede generar eustrés en quien se percibe capaz, y distrés en quien se percibe desbordado
...
El cuerpo se convierte en una máquina de acción. Rápido. Eficiente. Orientado a un único objetivo: sobrevivir. #metafora
...
#teoria
La respuesta de estrés está diseñada para ser **temporal**. Activación, acción, resolución, recuperación.

### El ciclo natural

En la naturaleza, el ciclo se completa: la cebra huye del león, escapa, y minutos después pasta tranquilamente. El sistema retorna al equilibrio. #metafora
...
El problema surge cuando **el ciclo no se cierra**. Los estresores psicológicos y sociales no se resuelven con huir o luchar. La amenaza percibida persiste: el proyecto sin terminar, el conflicto sin resolver, la incertidumbre sin respuesta. #ejemplo

El cuerpo mantiene la activación sin completar el ciclo. **Pico tras pico, sin retorno a la línea base.** #metafora
...
### Respuesta adaptativa vs. respuesta crónica

| Respuesta adaptativa | Respuesta crónica |
|---------------------|-------------------|
| Estado normal → Evento → Activación → Acción resolutiva → Relajación profunda → Retorno al estado normal | Estado normal → Evento percibido → Activación → Activación sostenida → Agotamiento |
...
**Fase 1 - Alarma**
El organismo detecta el estresor y moviliza recursos. Es la activación inicial, la respuesta de lucha o huida en acción.

**Fase 2 - Resistencia**
El cuerpo intenta adaptarse al estresor sostenido. Los niveles de activación se mantienen elevados mientras el organismo hace frente a la demanda. Los recursos se consumen.

**Fase 3 - Agotamiento**
Las reservas se vacían. La capacidad de resistencia se agota. El cuerpo ya no puede mantener la respuesta adaptativa.
...
### La curva de estrés y rendimiento

La relación entre activación y rendimiento sigue una curva:

- **Demasiado poco estrés** → Inactividad, pasividad
- **Nivel óptimo de estrés** → Potencia el rendimiento
- **Demasiado estrés** → Fatiga, agotamiento, ansiedad, colapso

**La resistencia del cuerpo al estrés tiene un límite; ignorarlo tiene consecuencias.**
