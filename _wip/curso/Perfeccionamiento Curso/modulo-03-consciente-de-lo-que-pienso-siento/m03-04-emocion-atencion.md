...
modulo: 3
orden: 04
tags: [filtro-atencional, amigdala, estrechamiento-ampliacion, atencion-emocional, mente-automatica, ciclo-perpetuacion, emociones-negativas, emociones-positivas]
...
#grafica ![graf-m03-04-lente-emocion-filtro](assets/graf-m03-04-lente-emocion-filtro.png) Ojo con lente emocional (miedo/ansiedad) que enfoca amenazas y difumina oportunidades y soluciones.
...
#imagen ![img-m03-04-emocion-manda-atencion-secuestrada](assets/img-m03-04-emocion-manda-atencion-secuestrada.png) "Emoción Manda": persona con araña gigante (miedo) capturando toda la atención mientras el entorno es ignorado.

#grafica ![graf-m03-04-filtro-emocional-foco-significado](assets/graf-m03-04-filtro-emocional-foco-significado.png) Entorno caótico → filtro emocional (función 1: foco, función 2: significado) → percepción consciente.
...
#ppt ![ppt-m03-04-amigdala-centinela](assets/ppt-m03-04-amigdala-centinela.png) Slide "La amígdala: un centinela que opera antes de la consciencia" con vía rápida y vía lenta.

#grafica ![graf-m03-04-brecha-reaccion-timeline](assets/graf-m03-04-brecha-reaccion-timeline.png) Timeline: estímulo (T=0) → detección amígdala (50ms) → brecha de reacción → consciencia plena (500+ms).

---

## 3. Estrechamiento vs. ampliacion de la atención

#grafica ![graf-m03-04-estrechamiento-vs-ampliacion](assets/graf-m03-04-estrechamiento-vs-ampliacion.png) Lentes comparativas: emociones negativas = estrechamiento (tunnel vision 15°) vs positivas = ampliación (gran angular 120°).
...
#grafica ![graf-m03-04-ciclo-perpetuacion-habito](assets/graf-m03-04-ciclo-perpetuacion-habito.png) Ciclo: estímulo → reacción automática → acción/conducta → refuerzo (memoria implícita).

#grafica ![graf-m03-04-autopista-circuito-habito](assets/graf-m03-04-autopista-circuito-habito.png) Circuito neural en wireframe con autopista roja iluminada representando la consolidación sináptica de hábitos.
...
#infografia ![infog-m03-04-emocion-atencion-filtro](assets/infog-m03-04-emocion-atencion-filtro.jpg) Infografía "Emoción y Atención: El Filtro de tu Realidad".