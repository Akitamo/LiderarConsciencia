...
Por que recordamos unas experiencias y olvidamos otras?

T3 introdujo que la memoria genera automatismos. Pero queda una pregunta crucial: que determina que experiencias se graban y cuales se desvanecen?

La respuesta son las emociones. Este tema revela el **mecanismo por el cual las emociones actuan como filtro y amplificador del aprendizaje**. Lo que te emociona se graba; lo que te deja indiferente se olvida.
...
La dopamina tambien facilita la plasticidad sinaptica, fortaleciendo las conexiones entre las neuronas involucradas en la experiencia.

**El hipocampo como modulador

El hipocampo —estructura fundamental para la formacion de nuevos recuerdos (T3)— esta estrechamente conectado con las areas que procesan emociones.

Esta conexion permite que las emociones modulen directamente la formacion de recuerdos: los eventos emocionales activan con mayor intensidad el hipocampo, favoreciendo la consolidacion.

**Conjuntos neuronales mas robustos

La liberacion de dopamina y la mayor actividad del hipocampo fortalecen las conexiones sinapticas entre las neuronas que forman los conjuntos neuronales.

Esto explica por que los recuerdos emocionales son:
- Mas vividos
- Mas duraderos
...
**Tus automatismos tienen historia emocional
...
**Integracion con T1-T3

- **T1:** Las emociones senalan que el modelo predictivo necesita actualizarse
- **T3:** Las emociones determinan que experiencias se consolidan como automatismos

**Preparacion para T5-T8

- **T5 (Integracion cerebral):** El hipocampo y las areas emocionales se integran en la arquitectura cerebral
- **T6 (Dos sistemas):** El Sistema 1 opera con la carga emocional grabada
- **T7 (Sesgos):** Muchos sesgos tienen componente emocional (aversion a la perdida, exceso de confianza)
- **T8 (Emociones y decision):** Profundizara en como las emociones influyen en la toma de decisiones
