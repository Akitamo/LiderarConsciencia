# Tema 4: La acción consciente y ética

## El modelo integrador en la práctica

**Pregunta que responde este tema:** ¿Cómo integro todo lo que he aprendido — propósito, capacidades, proceso — en la acción real, momento a momento, con orientación ética?
...
En M7 has añadido la dimensión ética: la atención como acto moral (T1), la virtud y los puntos ciegos (T2), el propósito como brújula y el modelo de alineamiento (T3).
...
![](../../../CURSO/modulo-07-consciente-de-lo-que-esta-bien/recursos/imagenes/Modelo%20integrador.png)

### El eje de alineamiento (de T3)
...
El objetivo no es depender del modelo. Es que la consciencia que representa se vuelva hábito. Como la virtud de T2: no lo que haces puntualmente, sino quien eres.
...
- Sabes qué significa ser ético (T2)
- Tienes una brújula de propósito (T3)
- Tienes una estructura para la acción (T4)

El Tema 5 cierra el programa. No añade contenido nuevo — integra todo el viaje y te proyecta hacia adelante.
