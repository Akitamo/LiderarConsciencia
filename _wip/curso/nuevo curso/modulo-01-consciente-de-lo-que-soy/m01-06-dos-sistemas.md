...
Por que tomo decisiones que luego no entiendo?

El modelo de Kahneman (Sistema 1/Sistema 2) ofrece el vocabulario central para entender como opera la mente.
...
- **Rapido:** Opera en milisegundos
- **Automatico:** No requiere esfuerzo consciente
- **Emocional:** Guiado por afecto, no por logica
- **Asociativo:** Conecta ideas por similitud y experiencia
- **Siempre activo:** Nunca se "apaga"


#ejemplo 
- Reconocer caras y expresiones
- Detectar hostilidad en una voz
- Completar la frase "pan con..."
- Orientarse en espacios conocidos
- Conducir por rutas habituales
- La mayoria de decisiones cotidianas
...
- **Lento:** Requiere tiempo para procesar
- **Deliberativo:** Requiere esfuerzo consciente
- **Logico:** Opera con reglas y calculos
- **Secuencial:** Procesa paso a paso
- **Perezoso por diseno:** Solo se activa cuando es necesario

#ejemplo 
El Sistema 2 se encarga de:
- Calcular 17 x 24
- Comparar dos productos por multiples criterios
- Rellenar un formulario de impuestos
- Aparcar en un espacio estrecho
- Verificar la validez de un argumento

**Por que es "perezoso"

El Sistema 2 consume mucha energia (la corteza prefrontal es metabolicamente costosa). Por eficiencia, el cerebro lo reserva para cuando es estrictamente necesario.
...
#ejemplo
*Percepción*: El Sistema 1 permite percibir instantáneamente profundidad y distancia entre objetos —la diferencia de altura entre dos torres. Calcular la longitud total de un conjunto de líneas requiere al Sistema 2: implica estimación, conteo y multiplicación.

#ejemplo
*Asociación*: El Sistema 1 asocia ideas automáticamente, creando historias coherentes incluso con información limitada. Al leer "Mindik es inteligente y fuerte...", puede llevarnos a concluir que sería buena líder, sin considerar otros aspectos de su personalidad.

#ejemplo
*Sustitución*: Ante preguntas difíciles, el Sistema 1 puede sustituirlas por preguntas más fáciles. En lugar de evaluar la probabilidad de que Bill sea músico de jazz aficionado, evalúa cuánto se parece Bill al estereotipo de un jazzista aficionado.
...
"Yo decido conscientemente mis acciones importantes."

**Lo que ocurre

1. El Sistema 1 evalua la situacion instantaneamente
2. El Sistema 1 genera una respuesta o propuesta
3. El Sistema 2 "revisa" (superficialmente en la mayoria de casos)
4. El Sistema 2 ratifica la propuesta del Sistema 1
5. Experimentamos esto como "decision consciente"

**La racionalidad como racionalizacion
...
El Sistema 2 se desactiva aun mas, y el Sistema 1 toma el control total.

Esto explica por que:
- Las peores decisiones se toman al final del dia
- El estres produce respuestas reactivas
- La sobrecarga lleva a atajos que luego lamentamos
...
- **T2** mostro como los sentidos alimentan esa construccion
- **T3** revelo como la memoria genera automatismos
- **T4** mostro como las emociones determinan que se graba
- **T5** presento las estructuras que integran el procesamiento

Ahora entendemos *quien* construye: principalmente el Sistema 1. La "realidad" que experimentamos es la propuesta del piloto automatico, basada en automatismos (T3) con carga emocional (T4), ejecutados por ganglios basales y corteza (T5).

---

## Conexion con el programa

- **M4 (estres):** Mostrara como la presion favorece al Sistema 1
- **M6 (decision consciente):** Entrenara la capacidad de observar al Sistema 1 en accion mediante el modelo ANTES-DURANTE-DESPUES
- **M7 (accion etica):** Requerira que el Sistema 2 intervenga en momentos criticos
...
Los procesos organizacionales suelen asumir:
- Que las personas leen los documentos completos
- Que los comites deliberan racionalmente
- Que las decisiones siguen los procedimientos formales

La realidad: el Sistema 1 opera tambien en contextos organizacionales, y los procesos formales muchas veces son rituales que ratifican decisiones ya tomadas.
