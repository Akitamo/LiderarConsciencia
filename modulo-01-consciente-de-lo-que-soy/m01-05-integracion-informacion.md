---
id: m01-05
titulo: "Integración de la Información"
modulo: 1
orden: 05
...
- La Corteza Prefrontal y la Decisión Consciente
  - Evaluación y planificación
  - Regulación emocional
  - Control inhibitorio

#imagen
<!-- IMAGEN: m01-05-mapa-cerebro-funciones -->
<!-- Descripción: Diagrama anatómico del cerebro humano en vista lateral con las diferentes áreas funcionales etiquetadas y coloreadas: Sinergias motoras suplementarias, Motora voluntaria (azul claro), Somatosensitiva (rosa), Habilidades manuales, Lenguaje (múltiples áreas), Elaboración del pensamiento, Giro de los ojos, Sens. II Audición (violeta), Patrones de la memoria, Visión bilateral (amarillo), Visión contralateral. Muestra cómo diferentes regiones del cerebro se especializan en distintas funciones cognitivas y sensoriales. -->
...
#video
<!-- VIDEO: m01-05-integracion-informacion -->
<!-- Descripción: Vídeo documental (aparece logo de La 2 de TVE) mostrando una escena urbana/industrial con una persona en movimiento. Ilustra el procesamiento e integración de información que realiza el cerebro constantemente mientras navegamos por el entorno, tomando decisiones automáticas y conscientes de forma simultánea. -->
